...
paths = Namespace(
    ...
    skipDataset="./data/Homer_skipgram_dataset_lemmatized.npy",
    vocab='./data/vocabs/Homer_word_frequencies_lemmatized.json',
    # Pytorch model
    model='data/models/Skipgram_Pytorch_0602_lemmatized.pth',
    embeddings="data/models/embeddings_lemmatized.npy",
    plots="data/assets/losses_plot.png",
    tsne_plot="data/assets/tsne_plot_lemmatized.html"
)
